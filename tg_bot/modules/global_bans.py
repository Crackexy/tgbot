...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if sql.is_user_gbanned(user_id):
        if not reason:
            message.reply_text("This User Is Already gbanned; I Would Have Changed The Reason, But You Haven't Given Me One...")
            return
    ...
    message.reply_text("Here We Go Again!\n Starting Another Global Ban 😌")
...
def ungban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("I Forgive {}, and Globally Give Him Another chance.".format(user_chat.first_name))
...
def gbanlist(bot: Bot, update: Update):
    ...
    with BytesIO(str.encode(banfile)) as output:
        ...
        update.effective_message.reply_document(document=output, filename="gbanlist.txt",
                                                caption="Here is the list of currently gbanned users in @ChiyoRobot.")
